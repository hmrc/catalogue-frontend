      ...
      serviceEndpoint(
        ...
        willRespondWith = (
          ...
          Some("""{"applicationName":"service-1",
                 |"versions":[
                 |{"environment":"production","versionNumber":"0.0.1","lastSeen":"2020-02-14T00:59:33"},
                 |{"environment":"qa","versionNumber":"0.0.1","lastSeen":"2020-02-14T01:00:14"}
                 |]}""".stripMargin))
      )
      serviceEndpoint(
        GET,
        ...
        serviceEndpoint(
          ...
          willRespondWith = (
            ...
            Some("""{"applicationName":"service-1",
                   |"versions":[
                   |{"environment":"production","versionNumber":"0.0.1","lastSeen":"2020-02-14T00:59:33"},
                   |{"environment":"development","versionNumber":"0.0.1","lastSeen":"2020-02-14T01:00:14"}
                   |]}""".stripMargin))
        )
        serviceEndpoint(GET, "/api/sluginfo?name=service-1", willRespondWith = (200, Some(serviceDependenciesData)))
