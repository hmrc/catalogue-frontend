...
import uk.gov.hmrc.cataloguefrontend.connector.UserManagementPortalConnector.{SlackInfo, TeamMember, UMPError}
...
class UserManagementPortalConnectorSpec
  extends AnyWordSpec
     with Matchers
  ...
  private lazy val userManagementConnector: UserManagementPortalConnector =
    app.injector.instanceOf[UserManagementPortalConnector]
