    ...
    "fetch and deserialise historic `ResourceUsage` for a service" in {
      ...
      resourceUsageConnector.historicResourceUsageForService("some-service").futureValue shouldBe List(
          ResourceUsage(
            ...
            serviceName = "some-service",
            values      = Map(
                            Environment.Integration  -> ResourceUsageValue(0, 0),
                            Environment.Development  -> ResourceUsageValue(0, 0),
                            Environment.ExternalTest -> ResourceUsageValue(0, 0),
                            Environment.Staging      -> ResourceUsageValue(0, 0),
                            Environment.Production   -> ResourceUsageValue(1, 2),
                            Environment.QA           -> ResourceUsageValue(0, 0)
                          )
          ),
          ResourceUsage(
          ...
          ResourceUsage(
            ...
            values      = Map(
                            ...
                            Environment.ExternalTest -> ResourceUsageValue(0, 0),
                            Environment.Staging      -> ResourceUsageValue(0, 0),
                            Environment.Production   -> ResourceUsageValue(5, 6),
                            Environment.QA           -> ResourceUsageValue(3, 4)
                          )
          )
          ,
          ResourceUsage(
